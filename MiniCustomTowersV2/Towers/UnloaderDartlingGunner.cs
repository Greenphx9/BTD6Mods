    ...
    public class UnloaderDartlingGunnerTower
    {
        public class UnloaderDartlingGunner : ModTower
        {
            ...
            public override void ModifyBaseTowerModel(TowerModel towerModel)
            {
                ...
                attackModel.weapons[0].emission = new ArcEmissionModel("ArcEmissionModel_", 2, 0.0f, 30.0f, null, false);
                attackModel.weapons[0].projectile.GetDamageModel().damage += 1.0f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[1].emission = new ArcEmissionModel("ArcEmissionModel_", 3, 0.0f, 30.0f, null, false);
                attackModel.weapons[1].startInCooldown = true;
                attackModel.weapons[1].customStartCooldown = 0.075f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[2].emission = new ArcEmissionModel("ArcEmissionModel_", 4, 0.0f, 30.0f, null, false);
                attackModel.weapons[2].startInCooldown = true;
                attackModel.weapons[2].customStartCooldown = 0.150f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[3].emission = new ArcEmissionModel("ArcEmissionModel_", 5, 0.0f, 30.0f, null, false);
                attackModel.weapons[3].startInCooldown = true;
                attackModel.weapons[3].customStartCooldown = 0.225f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[4].emission = new ArcEmissionModel("ArcEmissionModel_", 6, 0.0f, 30.0f, null, false);
                attackModel.weapons[4].startInCooldown = true;
                attackModel.weapons[4].customStartCooldown = 0.300f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[5].emission = new ArcEmissionModel("ArcEmissionModel_", 7, 0.0f, 30.0f, null, false);
                attackModel.weapons[5].startInCooldown = true;
                attackModel.weapons[5].customStartCooldown = 0.375f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[6].emission = new ArcEmissionModel("ArcEmissionModel_", 8, 0.0f, 30.0f, null, false);
                attackModel.weapons[6].startInCooldown = true;
                attackModel.weapons[6].customStartCooldown = 0.450f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[7].emission = new ArcEmissionModel("ArcEmissionModel_", 9, 0.0f, 30.0f, null, false);
                attackModel.weapons[7].startInCooldown = true;
                attackModel.weapons[7].customStartCooldown = 0.525f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[8].emission = new ArcEmissionModel("ArcEmissionModel_", 9, 0.0f, 30.0f, null, false);
                attackModel.weapons[8].startInCooldown = true;
                attackModel.weapons[8].customStartCooldown = 0.600f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[9].emission = new ArcEmissionModel("ArcEmissionModel_", 10, 0.0f, 30.0f, null, false);
                attackModel.weapons[9].startInCooldown = true;
                attackModel.weapons[9].customStartCooldown = 0.675f;
                attackModel.AddWeapon(attackModel.weapons[0].Duplicate());
                attackModel.weapons[10].emission = new ArcEmissionModel("ArcEmissionModel_", 11, 0.0f, 30.0f, null, false);
