...
namespace minicustomtowers.Towers
{
    class PlasmaMonkey
    {
        ...
        { 
                ...
                {
                    LocalizationManager.instance.textTable.Add(customTowerName, "Plasma Monkey");
                }
            ...
            System.Collections.Generic.List<UpgradeModel> list = new System.Collections.Generic.List<UpgradeModel>();
                list.Add(new UpgradeModel(customTowerUpgrade1, 950, 0, new SpriteReference(guid: "QuadWhips"), 1, 1, 0, "", ""));
                list.Add(new UpgradeModel(customTowerUpgrade2, 1150, 0, new SpriteReference(guid: "Potency"), 1, 2, 0, "", ""));
                list.Add(new UpgradeModel(customTowerUpgrade3, 3350, 0, new SpriteReference(guid: "SolarFlares"), 1, 3, 0, "", ""));
                list.Add(new UpgradeModel(customTowerUpgrade4, 11900, 0, new SpriteReference(guid: "GammaRays"), 1, 4, 0, "", ""));
                list.Add(new UpgradeModel(customTowerUpgrade5, 28000, 0, new SpriteReference(guid: "OmegaRays"), 1, 5, 0, "", ""));
            ...
            CacheBuilder.toBuild.PushAll("QuadWhips", "Potency", "SolarFlares", "GammaRays", "OmegaRays", "Plasma0", "Plasma1", "Plasma2", "Plasma3", "Plasma4", "PlasmaMonkey", "PlasmaMonkey2", "PlasmaMonkey3", "PlasmaMonkey4", "PlasmaMonkey5");
        ...
        static string customTowerName = "Plasma Monkey";
        static string customTowerDisplay = "";
        static string customTowerUpgrade1 = "Quad Whip";
        static string customTowerUpgrade2 = "Potency";
        static string customTowerUpgrade3 = "Solar Flares";
        static string customTowerUpgrade4 = "Gamma Rays";
        static string customTowerUpgrade5 = "Omega Rays";
        ...
        public static TowerModel getT0(GameModel gameModel)
        {
            ...
            towerModel.cost = 1100;
            towerModel.isGlobalRange = false;
            towerModel.portrait = new SpriteReference(guid: "PlasmaMonkey");
            towerModel.icon = new SpriteReference(guid: "PlasmaMonkey");
            towerModel.instaIcon = new SpriteReference(guid: "PlasmaMonkey");
            ...
            attackModel.weapons[0].emission = new ArcEmissionModel("plasmamonkey", 2, 0.0f, 15.0f, null, false, false);
            attackModel.weapons[0].projectile.GetDamageModel().damage = 0.15f;
        ...
        public static TowerModel getT2(GameModel gameModel)
        {
            ...
            towerModel.tier = 2;
            towerModel.portrait = new SpriteReference(guid: "PlasmaMonkey2");
            ...
            attackModel.weapons[0].projectile.display = "Plasma1";
            return towerModel;
        }
        ...
        public static TowerModel getT3(GameModel gameModel)
        {
            ...
            towerModel.tier = 3;
            towerModel.portrait = new SpriteReference(guid: "PlasmaMonkey3");
            ...
            attackModel.weapons[0].projectile.display = "Plasma2";
            return towerModel;
        }
        ...
        public static TowerModel getT4(GameModel gameModel)
        {
            ...
            towerModel.tier = 4;
            towerModel.portrait = new SpriteReference(guid: "PlasmaMonkey4");
            ...
            towerModel.range += 10f;
            attackModel.range += 10f;
            attackModel.weapons[0].projectile.display = "Plasma3";
            return towerModel;
        }
        ...
        public static TowerModel getT5(GameModel gameModel)
        {
            ...
            towerModel.tier = 5;
            towerModel.portrait = new SpriteReference(guid: "PlasmaMonkey5");
            ...
            AttackModel attackModel = towerModel.GetBehavior<AttackModel>();
            attackModel.weapons[0].projectile.GetDamageModel().damage = 7f;
            towerModel.range += 10f;
            attackModel.range += 10f;
            attackModel.weapons[0].projectile.display = "Plasma4";
            attackModel.weapons[0].projectile.radius *= 1.5f;
