...
namespace minicustomtowers.Towers
{
    class BloontoniumDarts
    {
        ...
        { 
                ...
                "Shoots super fast. Darts pop 3 layers.",
                //"+Fire-Rate",
            ...
            System.Collections.Generic.List<UpgradeModel> list = new System.Collections.Generic.List<UpgradeModel>();
                list.Add(new UpgradeModel(customTowerUpgrade1, 750, 0, new SpriteReference(guid: "BloontoniumDarts1"), 1, 1, 0, "", ""));
                list.Add(new UpgradeModel(customTowerUpgrade2, 1800, 0, new SpriteReference(guid: "BloontoniumDarts2"), 1, 2, 0, "", ""));
            ...
            CacheBuilder.toBuild.PushAll("BloontoniumDarts1", "BloontoniumDarts2", "BloontoniumDartsIcon", "BloontoniumDartsPortrait");
        ...
        static string customTowerName = "Bloontonium Darts";
        static string customTowerDisplay = "";
        static string customTowerUpgrade1 = "Dart Gunner";
        static string customTowerUpgrade2 = "Dart Tank";
        ...
        {
            TowerModel towerModel = gameModel.GetTowerFromId("DartMonkey-202").Duplicate<TowerModel>(); //gameModel.GetTowerFromId(Alchemist).Duplicate<TowerModel>();
        ...
        public static TowerModel getT1(GameModel gameModel)
        {
            ...
            towerModel.display = "98a2ac8dce5e5c3439d0f7c988933117";
            return towerModel;
        }
        ...
        public static TowerModel getT2(GameModel gameModel)
        {
            ...
            towerModel.display = "375d3e2de97beb64aae9368bab234aa4";
            var churchilHead = gameModel.GetTowerFromId("CaptainChurchill").GetAttackModel().GetBehavior<DisplayModel>().Duplicate<DisplayModel>();
            attackModel.AddBehavior(churchilHead);
            return towerModel;
        }
